function getCityConfigWithProvinceCode(provinceCode){
    ...
    if (provinceCode == 3){
        //河北
        cityList.push({"code": 73, "label": "石家庄"});
        cityList.push({"code": 74, "label": "唐山"});
        cityList.push({"code": 75, "label": "秦皇岛"});
        cityList.push({"code": 76, "label": "邯郸"});
        cityList.push({"code": 77, "label": "邢台"});
        cityList.push({"code": 78, "label": "保定"});
        cityList.push({"code": 79, "label": "张家口"});
        cityList.push({"code": 80, "label": "承德"});
        cityList.push({"code": 81, "label": "衡水"});
        cityList.push({"code": 82, "label": "廊坊"});
        cityList.push({"code": 83, "label": "沧州"});
    } else if (provinceCode == 4){
        //山西
        cityList.push({"code": 84, "label": "太原"});
        cityList.push({"code": 85, "label": "大同"});
        cityList.push({"code": 86, "label": "阳泉"});
        cityList.push({"code": 87, "label": "长治"});
        cityList.push({"code": 88, "label": "晋城"});
        cityList.push({"code": 89, "label": "朔州"});
        cityList.push({"code": 90, "label": "晋中"});
        cityList.push({"code": 91, "label": "运城"});
        cityList.push({"code": 92, "label": "忻州"});
        cityList.push({"code": 93, "label": "临汾"});
        cityList.push({"code": 94, "label": "吕梁"});
    }else if (provinceCode == 5){
        //内蒙古
        cityList.push({"code": 95, "label": "呼和浩特"});
        cityList.push({"code": 96, "label": "包头"});
        cityList.push({"code": 97, "label": "乌海"});
        cityList.push({"code": 98, "label": "赤峰"});
        cityList.push({"code": 99, "label": "通辽"});
        cityList.push({"code": 100, "label": "鄂尔多斯"});
        cityList.push({"code": 101, "label": "呼伦贝尔"});
        cityList.push({"code": 102, "label": "巴彦淖尔"});
        cityList.push({"code": 103, "label": "乌兰察布"});
        cityList.push({"code": 104, "label": "兴安盟"});
        cityList.push({"code": 105, "label": "锡林郭勒盟"});
        cityList.push({"code": 106, "label": "阿拉善盟"});
    }else if (provinceCode == 6){
        //辽宁
        cityList.push({"code": 107, "label": "沈阳"});
        cityList.push({"code": 108, "label": "大连"});
        cityList.push({"code": 109, "label": "鞍山"});
        cityList.push({"code": 110, "label": "抚顺"});
        cityList.push({"code": 111, "label": "本溪"});
        cityList.push({"code": 112, "label": "丹东"});
        cityList.push({"code": 113, "label": "锦州"});
        cityList.push({"code": 114, "label": "营口"});
        cityList.push({"code": 115, "label": "阜新"});
        cityList.push({"code": 116, "label": "辽阳"});
        cityList.push({"code": 117, "label": "盘锦"});
        cityList.push({"code": 118, "label": "铁岭"});
        cityList.push({"code": 119, "label": "朝阳"});
        cityList.push({"code": 120, "label": "葫芦岛"});
    }else if (provinceCode == 7){
        //吉林
        cityList.push({"code": 121, "label": "长春"});
        cityList.push({"code": 122, "label": "吉林"});
        cityList.push({"code": 123, "label": "四平"});
        cityList.push({"code": 124, "label": "辽源"});
        cityList.push({"code": 125, "label": "通化"});
        cityList.push({"code": 126, "label": "白山"});
        cityList.push({"code": 127, "label": "松原"});
        cityList.push({"code": 128, "label": "白城"});
        cityList.push({"code": 129, "label": "延边朝鲜族自治州"});
    }else if (provinceCode == 8){
        //黑龙江
        cityList.push({"code": 130, "label": "哈尔滨"});
        cityList.push({"code": 131, "label": "齐齐哈尔"});
        cityList.push({"code": 132, "label": "鸡西"});
        cityList.push({"code": 133, "label": "鹤岗"});
        cityList.push({"code": 134, "label": "双鸭山"});
        cityList.push({"code": 135, "label": "大庆"});
        cityList.push({"code": 136, "label": "伊春"});
        cityList.push({"code": 137, "label": "佳木斯"});
        cityList.push({"code": 138, "label": "七台河"});
        cityList.push({"code": 139, "label": "牡丹江"});
        cityList.push({"code": 140, "label": "黑河"});
        cityList.push({"code": 141, "label": "绥化"});
        cityList.push({"code": 142, "label": "大兴安岭地区"});
