 ...
 *
 */
class VideoVendorBind extends \yii\db\ActiveRecord
{
    // *** 账号类型 ***
    const ACCOUNT_TYPE_HUAJIAO = 1; // 花椒
    const ACCOUNT_TYPE_PANDA = 2; // 熊猫
    const ACCOUNT_TYPE_HANI = 3; // 来疯
    ...
    const BIND_STATUS_DEFAULT = -1;//未填写完成
    const BIND_STATUS_WAIT_VERIFY = 0;//待审核
    const BIND_STATUS_VERIFY_SUCCESS = 1;//审核通过
    const BIND_STATUS_VERIFY_ERROR = 9;//审核未通过
    /**
     * @inheritdoc
     */
    public static function tableName()
    {
        return 'video_vendor_bind';
    }
