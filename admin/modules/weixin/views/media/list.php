...
$globalOrigRetailRatio = PlatformHelper::getGlobalOrigRetailRatio();
...
$weixinToVerifyJs = <<<JS
            ...
            // 控制左侧导航选中
            if(!$('#weixin .media-manage .to-list').hasClass('active')){
                ...
                $('#weixin.menu-level-1 .menu-level-2.media-manage .menu-level-3.to-list').addClass('active');
            }
            ...
            $('#modal-to-verify').on('click', '.btn-commit-media', function(){
                ...
                var follower_num = $.trim(this_modal.find('.input-follower-num').val()); // 粉丝数(单位:万)
...
JS;
            ...
            <div class="panel panel-inverse pjax-area">
                <?= Html::beginForm(Yii::$app->urlManager->createUrl(array('weixin/media/list', 'vendor_uuid' => $vendor_uuid)), 'post', ['data-pjax' => '', 'class' => 'weixin-search-form']); ?>
                <div class="p-t-30">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="account"
                                       ...
                                       placeholder="公众号名称或ID" class="form-control input-sm">
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control">
                                    ...
                                    <option value="2" <?php echo Yii::$app->request->post('status', -1) == 2 ? 'selected' : '' ?>>无效账号</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <?= GridView::widget([
                            ...
                            'columns' => [
                                ...
                                [
                                    ...
                                    'format' => 'html',
                                    'headerOptions' => ['data-sort-ignore' => 'true'],
                                    'contentOptions' => ['class' => 'comment', 'style' => 'max-width: 200px'],
                                    'value' => function ($model, $key, $index, $column) {
                                        $comment = '';
                                ...
                                [
                                    ...
                                    'contentOptions' => ['class' => 'put-up'],
                                    'value' => function ($model, $key, $index, $column) {
                                        if ($model['weixin_status'] == 1 &&$model['has_pref_vendor']==1) {
                                            return '<span class="label label-danger">已审核</span>';
                                        } elseif($model['weixin_status']==3||$model['weixin_status']==4){
                                            return '<span class="label label-default">无效账号</span>';
                                        }else{
