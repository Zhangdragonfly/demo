...
$weixinToVerifyJs = <<<JS
            ...
            // 控制左侧导航选中
            if(!$('#weixin .media-manage .to-update').hasClass('active')){
                ...
                $('#weixin.menu-level-1 .menu-level-2.media-manage .menu-level-3.to-update').addClass('active');
            }
            ...
            $('#modal-to-verify #stage-to-verify-vendor-content .area-vendor-detail .one-pos.pos-s .pub-type input:radio[name="pos-s-pub-type"]').change(function() {
                ...
                if(pub_type == 0){
                    ...
                    if(!isNaN(retail_price_min) && retail_price_min > 0){
                        ...
                        vendorDetailArea.find('.one-pos.pos-s .retail-price .retail-price-val-min').val(getDefaultRetailPrice(origin_price_min));
                    }
            ...
            $('#modal-to-verify #stage-to-verify-vendor-content .area-vendor-detail .one-pos.pos-m-1 .pub-type input:radio[name="pos-m-1-pub-type"]').change(function() {
                ...
                if(pub_type == 0){
                    ...
                    if(!isNaN(retail_price_min) && retail_price_min > 0){
                        ...
                        vendorDetailArea.find('.one-pos.pos-m-1 .retail-price .retail-price-val-min').val(getDefaultRetailPrice(origin_price_min));
                    }
            ...
            $('#modal-to-verify #stage-to-verify-vendor-content .area-vendor-detail .one-pos.pos-m-2 .pub-type input:radio[name="pos-m-2-pub-type"]').change(function() {
                ...
                if(pub_type == 0){
                    ...
                    if(!isNaN(retail_price_min) && retail_price_min > 0){
                        ...
                        vendorDetailArea.find('.one-pos.pos-m-2 .retail-price .retail-price-val-min').val(getDefaultRetailPrice(origin_price_min));
                    }
            ...
            $('#modal-to-verify #stage-to-verify-vendor-content .area-vendor-detail .one-pos.pos-m-3 .pub-type input:radio[name="pos-m-3-pub-type"]').change(function() {
                ...
                if(pub_type == 0){
                    ...
                    if(!isNaN(retail_price_min) && retail_price_min > 0){
                        ...
                        vendorDetailArea.find('.one-pos.pos-m-3 .retail-price .retail-price-val-min').val(getDefaultRetailPrice(origin_price_min));
                    }
...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">待更新</li>
    </ol>

    <h1 class="page-header">待更新</h1>
...
JS;
            ...
            <div class="panel panel-inverse pjax-area">
                <?= Html::beginForm(['media/to-update-list'], 'post', ['data-pjax' => '', 'class' => 'weixin-search-form']); ?>
                <div class="p-t-30">
...
//                                ],
                                ...
                                [
                                    ...
                                    'header' => '操作',
                                    'template' => '{to-verify}<br>{put-up}<br>{set-top}',
                                    'buttons' => [
            ...
            <table id="header-fixed" class="footable table table-striped toggle-arrow-tiny table-media-list" style="position: fixed;top: 54px;display: none;margin-left: 15px">
                <thead>
                <tr>
                    <th data-sort-ignore="true">平台id</th>
                    <th data-sort-ignore="true">公众号</th>
                    <th data-sort-ignore="true">接单</th>
