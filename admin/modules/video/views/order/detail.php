                ...
                <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                    <div class="panel-body">
                        <table class="table">
                            ...
                            ?>
                            <tr>
                                <td><?=!empty($data['account_name'])?$data['account_name']:"";?></td>
                ...
                <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <button type="text" class="btn btn-success btn-save" data-uuid="<?=!empty($data['uuid'])?$data['uuid']:"";?>" data-url="<?=Yii::$app->urlManager->createUrl(array('video/order/update-order'))?>">保存</button>
                                <button type="text" class="btn btn-primary btn-cancel" data-url="<?=Yii::$app->urlManager->createUrl(array('video/order/list'))?>">返回</button>
                            </div>
                        </div>
                    </div>
                </div>
