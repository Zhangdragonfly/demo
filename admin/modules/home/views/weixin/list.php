...
$(function(){
    ...
    if(!$('#website-manage .home-list').hasClass('active')){
        ...
        $('#website-manage.menu-level-1 .menu-level-2.weixin-list').addClass('active');
    };
    // 简介(提交)
...
JS;
            ...
            ?>
            <?= Html::beginForm(['list'], 'post', ['data-pjax' => '', 'class' => 'weixin-search-form']); ?>
            <div class="col-md-3" style="float: none;padding-left: 0px;">
                ...
                <select class="form-control input-sm" name="media_cate">
                    ...
                    <option value="4" <?= $cate == 4 ? 'selected' : '' ?>>汽车</option>
                    <option value="10" <?= $cate == 10 ? 'selected' : '' ?>>母婴/育儿</option>
                    <option value="7" <?= $cate == 7 ? 'selected' : '' ?>>IT/互联网</option>
                    <option value="5" <?= $cate == 5 ? 'selected' : '' ?>>时尚</option>
                    <option value="14" <?= $cate == 14 ? 'selected' : '' ?>>美食</option>
                    <option value="2" <?= $cate == 2 ? 'selected' : '' ?>>生活</option>
                    <option value="19" <?= $cate == 19 ? 'selected' : '' ?>>金融财经</option>
                    <option value="13" <?= $cate == 13 ? 'selected' : '' ?>>家居房产</option>
                </select>
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($model, $key, $index, $column) {
                                ...
                                return "<span>{$model['public_name']}</span><br/><span >{$info['weixin_id']}</span>";
                            },
                        ],
                        [
                            'header' => '分类',
                            ...
                            'value' => function ($model, $key, $index, $column) {
                                $cateList = MediaHelper::getMediaCateList();
