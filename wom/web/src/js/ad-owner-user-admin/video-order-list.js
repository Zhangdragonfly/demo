...
function pjaxRefOrder(){
    ...
    $("a[data-title]").each(function() {
        ...
        a.data('data-title', title).hover(function () {
                var offset = a.offset();
                $("<div class='show-all-info'>"+title+"</div>").appendTo($(".video-table")).css({ top: offset.top + a.outerHeight() + 6, left: offset.left + a.outerWidth() + 1 }).fadeIn(function () {
                });
            },
    ...
    //~~~~~删除已选择的资源~~~~~
    $(".video-order-table").on("click",".delete-order",function(){
