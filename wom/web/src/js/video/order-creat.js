$(function() {
    ...
    $(".source-choosed-table").on("click", ".delete", function () {
        ...
        var url = $("input[name=input-delete-video-order-url]").val();
    ...
    $('.dropdown .dropdown-menu').on('click', 'li', function () {
        ...
        var correspond_price = $(this).parents("tr").children(".price");
         if (price_location == "线上直播" || price_location == "原创视频" ) {
            //correspond_price.text(3000);
            $(this).parents("tr").find(".online-price").css("display","block");
            $(this).parents("tr").find(".offline-price").css("display","none");
        } else if (price_location == "线下活动" || price_location == "视频转发" ) {
            //correspond_price.text(3000);
            $(this).parents("tr").find(".online-price").css("display","none");
            $(this).parents("tr").find(".offline-price").css("display","block");
        }
    })
    ...
    $(".btn-submit-plan-order").on("click", function(){
        ...
        if ($(".show").length == 0) {
            ...
            $(".source-choosed-table tr").each(function(){
                ...
                switch(sub_type){
                    case '线上直播':var price = $(this).find(".online-price").text();sub_type=1;break;
                    case '线下活动':var price = $(this).find(".offline-price").text();sub_type=2;break;
                    case '原创视频':var price = $(this).find(".online-price").text();sub_type=3;break;
                    case '视频转发':var price = $(this).find(".offline-price").text();sub_type=4;break;
                }
